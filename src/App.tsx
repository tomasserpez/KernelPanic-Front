    ...
    <>
      <div className="bg-gray-50 dark:bg-gray-900 h-screen flex flex-col items-start">
        <div className="flex flex-col w-3/5 rounded overflow-hidden shadow-lg m-16 ms-40 p-4">
          ...
          <div className="font-bold text-7xl mb-2 text-slate-50 text-opacity-85">Bienvenido al cliente de SpaceTraders!</div>
        </div>
        ...
        {getUser() == null ? 
          ...
          : 
          <button onClick={cerrarSesionHandler} className="w-1/6 self-center text-white bg-primary-600 hover:bg-gray-800 focus:ring-4 focus:outline-none focus:ring-gray-700 font-medium rounded-lg text-base px-5 py-2.5 text-center">Cerrar Sesión</button>
        }  
        </div>
      </div>
      </div>     
