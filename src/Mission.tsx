            ...
            <div className="h-screen flex flex-col justify-center items-center relative">
                <div className="h-3/4 flex items-center justify-around">
                    ...
                    <div className="flex flex-col w-2/5 h-3/4 rounded border-purple-700 border-4 p-8 justify-between items-center">
                        <div className="flex flex-col">
                            ...
                            {agentContracts.map(
                                (agentContract,index) => <ContratoItem key={crypto.randomUUID as unknown as string} contract={agentContract}></ContratoItem>
                            )}
                        </div>
                    </div>
                </div>
                ...
                <nav className="w-5/6">
                    <ul className="flex justify-around">
                        ...
                        <li className="text-white rounded hover:cursor-pointer bg-purple-700 p-2 outline outline-purple-700 outline-4" title="Misiones">
                            <Link to="/mission">
                                <img
                                    src={missionIcon}
